...
if ( ! class_exists( 'AWS_Cache' ) ) :
    ...
    class AWS_Cache {
         ...
         */
        public function get_cache_name( $s, $form_id = 1, $filter_id = 1 ) {

            $s = sanitize_text_field( $s );
            $cache_option_name = 'aws_search_term_' . $form_id . '_' . $filter_id . '_' . $s;
        ...
        public function is_cache_table_not_exist() {
            ...
            return AWS_PRO()->option_vars->is_cache_table_not_exists();
