...
class AWS_Admin {
    ...
    */
    ...
    public function add_admin_page() {
        ...
        add_submenu_page( 'aws-options', __( 'Index Config', 'advanced-woo-search' ), __( 'Index Config', 'advanced-woo-search'), AWS_Admin_Helpers::user_admin_capability(), 'aws-performance', array( $this, 'display_admin_page' ) );
    }
        ...
        echo '<div class="wrap">';
            ...
            echo '<form data-current-tab="' . esc_attr( $current_tab ) . '" action="" name="aws_form" id="aws_form" method="post">';
                ...
                if ( ! $instance_id ) {
                    ...
                    } elseif ( $current_tab && $current_tab != 'general' ) {
                        new AWS_Admin_Fields( $current_tab, $common_settings );
                    } else {
                    ...
                    new AWS_Admin_Fields( 'results', $plugin_options );
    ...
    public function admin_enqueue_scripts() {
        ...
        if ( isset( $_GET['page'] ) && in_array( $_GET['page'], array( 'aws-options', 'aws-performance', 'aws-options-updates' ) ) ) {
            ...
            wp_enqueue_style( 'plugin-admin-style', AWS_PRO_URL . 'assets/css/admin' . $suffix . '.css', array(), 'pro' . AWS_PRO_VERSION );
            ...
            wp_enqueue_script( 'aws-tiptip', AWS_PRO_URL . '/assets/js/jquery.tipTip.js', array( 'jquery' ), 'pro' . AWS_PRO_VERSION );
            ...
            wp_localize_script( 'aws-admin', 'aws_vars', array(
                ...
                'copy_text' => __( '(copy)', 'advanced-woo-search' ),
            ) );
    ...
    /*
     * Check if some sources was disabled from index
     */
