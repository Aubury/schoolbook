    ...
    class AWS_Avada {
        ...
        public function avada_posts_per_page( $posts_per_page ) {
            ...
            if ( isset( $_GET['aws_id'] ) ) {
                $form_id = intval( $_GET['aws_id'] );
                $search_page_res_per_page = AWS_PRO()->get_settings( 'search_page_res_per_page', $form_id );
            ...
            fusion_builder_map(
                array(
                    ...
                    'params'     => array(
                        array(
                            'type'        => 'select',
                            'heading'     => esc_attr__( 'Form ID:', 'advanced-woo-search' ),
                            'description' => esc_attr__( 'Select search form instance', 'advanced-woo-search' ),
                            'param_name'  => 'id',
                            'default'     => $def_id,
                            'value'       => $form_ids,
                        ),
