        ...
        */
        ...
        public function attr_term_changed( $attribute_id, $data, $old_slug ) {
            ...
            if ( $new_slug && $new_slug !== $old_slug ) {
                ...
                $attr_sources = isset( $common_settings['index_sources'] ) && isset( $common_settings['index_sources']['attr'] ) && isset( $common_settings['index_sources']['attr']['fields'] ) ? $common_settings['index_sources']['attr']['fields'] : array();
                ...
                if ( $settings ) {
                    foreach( $settings as $search_instance_num => $search_instance_settings ) {
                        ...
                        if ( isset( $search_instance_settings['search_archives'] ) && isset( $search_instance_settings['search_archives']['archive_attr'] ) ) {

                            $attr_archive_old = $attr_slug_old;
                            $attr_archive_new = $new_slug;

                            $fields = isset( $search_instance_settings['search_archives']['archive_attr']['fields'] ) && is_array( $search_instance_settings['search_archives']['archive_attr']['fields'] ) ? $search_instance_settings['search_archives']['archive_attr']['fields'] : array();

                            if ( isset( $fields[$attr_archive_old] ) ) {
                                $old_val = $fields[$attr_archive_old];
                                unset( $settings[$search_instance_num]['search_archives']['archive_attr']['fields'][$attr_archive_old] );
                                $settings[$search_instance_num]['search_archives']['archive_attr']['fields'][$attr_archive_new] = $old_val;
                ...
                if ( $need_change_index ) {
                    ...
                    $old_attr_val = $common_settings['index_sources']['attr']['fields'][$attr_slug_old];
                    unset( $common_settings['index_sources']['attr']['fields'][$attr_slug_old] );
                    $common_settings['index_sources']['attr']['fields'][$new_slug] = $old_attr_val;
                    ...
                    if ( $settings ) {
                        ...
                        foreach( $settings as $search_instance_num => $search_instance_settings ) {
                            ...
                            if ( isset( $search_instance_settings['search_in'] ) && isset( $search_instance_settings['search_in']['attr'] ) && is_array( $search_instance_settings['search_in']['attr'] ) && isset( $search_instance_settings['search_in']['attr']['value'] ) && $search_instance_settings['search_in']['attr']['value'] === '1' ) {

                                $fields = isset( $search_instance_settings['search_in']['attr']['fields'] ) && is_array( $search_instance_settings['search_in']['attr']['fields'] ) ? $search_instance_settings['search_in']['attr']['fields'] : array();

                                if ( isset( $fields[$attr_slug_old] ) ) {
                                    $old_val = $fields[$attr_slug_old];
                                    unset( $settings[$search_instance_num]['search_in']['attr']['fields'][$attr_slug_old] );
                                    $settings[$search_instance_num]['search_in']['attr']['fields'][$new_slug] = $old_val;
                                    $update_settings = true;
                                }
