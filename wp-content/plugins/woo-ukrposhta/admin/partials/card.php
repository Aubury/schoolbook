<div>
    <div class="updated updatedpro mtb16 p0"  >
        <div class="card">
            ...
            <div class="card-body">
                <h5><a href="mailto:support@morkva.co.ua" 
                        class="wpbtn button button-primary" 
                        target="_blank"> Написати</a></h5>
    ...
    <div class="updated updatedpro mtb16 p0"  >
        <div class="card">
            ...
            <div class="card-body">
                ...
                <h5><a href="https://www.morkva.co.ua/shop/woo-ukrposhta-pro/" class="button button-primary">Детальніше</a></h5>
            </div>
        </div>
    </div>
    <div class="clear"></div>
